...
public class Problem3_7 {
	...
	public static void main(String[] args) 
	{
		...
		else { System.out.println(numQuarters + " quarter "); }
		if (numDimes != 1) {System.out.println(numDimes + " dimes "); }
		else { System.out.println(numDimes + " dime "); }
		if (numNickels != 1) { System.out.println(numNickels + " nickels "); }
		else { System.out.println(numNickels + " nickel "); }
		if (numPennies != 1) { System.out.println(numPennies + " pennies."); }
		else { System.out.println(numPennies + " penny"); }
